...
//        System.out.println("After Advice 동작");
    ...
    /* 필기. returning에 쓰인 이름이 반환값이 넘어오는 매개변수명과 일치해야 한다.(result) */
    @AfterReturning(pointcut = "logPointcut()", returning = "result")         // Pointcut에 해당하는 위치가 담긴 메소드가 같은 클래스에 있으면 클래스 소속을 안 적어도 된다.
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        /* 프록시 -> 타겟으로 삼는 값을 건들지 않고 새로운 값을 추가하거나 변경하기 위함. */
    }

    /* 설명. 4. AfterThrowing Advice */
    /* 필기. throwing 속성 괎과 매개변수명이 일치해야 한다.(exception) */
    ...
    /* 설명. 5. Around Advice */
    /* 설명.
     *  이 어드바이스는 조인포인트를 완전히 장학하기 때문에 앞서 살펴본 어드바이스 모두
